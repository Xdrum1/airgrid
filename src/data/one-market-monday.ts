  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        heading: "The Angle",
        paragraphs: [
          "Dallas is the only market in the AirIndex coverage universe with an FAA-authorized air taxi corridor. The DFW-to-Downtown Dallas route holds an active authorization that most markets have not begun pursuing. That makes Dallas the first real test of whether a market can move from regulatory readiness to operational readiness — and it is the weather gap that determines the answer.",
          ...
          "Nationally, only 18 heliports out of more than 5,600 in the FAA registry have their own weather station. Dallas has 69 heliports in the metro area. None has dedicated weather sensing. The airspace below 5,000 feet has been described by industry practitioners as a measurement desert — and the current infrastructure gap ranges from $50 wind cones to $300,000 ASOS systems with virtually nothing between. The gap is not unique to Dallas — it is structural across every market in the index. But it is most visible in Dallas because Dallas is closest to actually needing it.",
      ...
      },
      {
        heading: "What to Watch",
        paragraphs: [
          "Three forward signals will determine whether Dallas closes the gap between 95 and 100 within the next 12 months — and in doing so, becomes the first market in the index to demonstrate full operational readiness.",
