    ...
    sections: [
      {
        heading: "The Score",
        paragraphs: [
          "Miami sits at 80 on the AirIndex Readiness Score — ADVANCED tier, and one of only three markets in the United States to reach it. That score reflects a regulatory and operator stack that most markets are still trying to assemble: Florida's Advanced Air Mobility Act is enacted law, not a pending bill. Joby Aviation is operating helicopter air taxi routes out of the Blade Lounge at Opa-Locka Executive Airport, acquired in its August 2025 Blade acquisition. Archer Aviation has publicly committed to a MIA–Fort Lauderdale corridor in partnership with United Airlines. The Miami-Dade TPO published a UAM Policy Framework and Strategic Roadmap in November 2023, and the county rezoned Watson Island for heliport and vertiport use.",
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "AirIndex's pipeline classified 18 Miami-relevant signals in the last 30 days, ranking third nationally behind San Francisco and Phoenix. The composition is the more interesting number: 12 of those 13 operator expansion events arrived inside the last 30 days, meaning operator activity has accelerated, not just persisted. Add an FAA corridor filing for MIA–FLL classified at high confidence on March 30, and a state vertiport bill (FL H1093) signed two days ago, and the pipeline is showing a market where forward signals are clustered, not scattered. Miami's MarketWatch status is POSITIVE_WATCH with an IMPROVING outlook.",
        ],
      },
      {
        heading: "What to Watch",
