    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Nationally, only 18 heliports out of more than 5,600 in the FAA registry have their own weather station. Dallas has 69 heliports in the metro area. None has dedicated weather sensing. The gap is not unique to Dallas — it is structural across every market in the index. But it is most visible in Dallas because Dallas is closest to actually needing it.",
