...
const RAW_CITIES: City[] = [
  {
    ...
    regulatoryPosture: "friendly", stateLegislationStatus: "enacted", hasLaancCoverage: true,
    scoreSources: {
  ...
  },
  {
    ...
    activeOperators: ["op_joby", "op_archer"],
    regulatoryPosture: "neutral", stateLegislationStatus: "none", hasLaancCoverage: true,
    scoreSources: {
  ...
  },
  {
    ...
    scoreSources: {
      ...
      approvedVertiport: { citation: "Joby Miami helipad — operational for air taxi service (ex-Blade)", date: "2026-03" },
      activeOperatorPresence: { citation: "Joby operating Miami air taxi routes (via Blade acquisition Aug 2025); Archer planning MIA–FLL corridor", date: "2026-03" },
  ...
  },
  {
    ...
    activeOperators: [],
    regulatoryPosture: "neutral", stateLegislationStatus: "actively_moving", hasLaancCoverage: true,
    scoreSources: {
    ...
    notes: "Arizona has three coordinated AAM bills actively moving through the legislature — SB1827 (Office of Advanced Air Mobility), SB1826 (AAM appropriation), and SB1819 (Vertiports; design; zoning). This coordinated multi-bill pattern mirrors Texas and Florida before their legislation passed. Autonomous vehicle statute (ARS 28-9702) applies to ground vehicles only. Chandler/Tempe testing corridor activity exists. Excellent weather for year-round operations.",
    keyMilestones: ["AZ SB1827 Office of AAM transmit to House (Mar 2026)", "AZ SB1819 Vertiport zoning on consent calendar", "AZ SB1826 AAM appropriation in House", "Chandler/Tempe drone testing activity"],
    lastUpdated: "2025-02-01",
  },
  {
  ...
  },
  {
    ...
    hasActivePilotProgram: false, hasVertiportZoning: true, vertiportCount: 0,
    activeOperators: [],
    regulatoryPosture: "neutral", stateLegislationStatus: "enacted", hasLaancCoverage: true,
  ...
  },
  {
    ...
    hasActivePilotProgram: false, hasVertiportZoning: false, vertiportCount: 0,
    activeOperators: [],
    regulatoryPosture: "restrictive", stateLegislationStatus: "none", hasLaancCoverage: false,
  ...
  },
  {
    ...
    hasActivePilotProgram: false, hasVertiportZoning: false, vertiportCount: 0,
    activeOperators: [],
    regulatoryPosture: "friendly", stateLegislationStatus: "actively_moving", hasLaancCoverage: true,
    scoreSources: {
