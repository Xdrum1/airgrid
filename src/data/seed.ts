...
const RAW_CITIES: City[] = [
  {
    ...
    notes: "Primary US launch market for Joby and Archer. Joby now commercially operational in Dubai (Feb 2026) via Uber Air partnership — LA is the confirmed next US market. LA Metro actively planning vertiport integration with transit hubs. Largest near-term commercial opportunity in the US.",
    keyMilestones: ["Joby launches Uber Air in Dubai (Feb 2026)", "Joby/Archer targeting 2026 LA commercial ops", "LAX vertiport study underway", "CA UAM Task Force active"],
    lastUpdated: "2026-02-26",
  },
  {
  ...
  },
  {
    ...
    notes: "Texas passed landmark UAM-friendly legislation (HB 1735) in 2023. Wisk testing autonomous operations near DFW. Joby now commercially operational in Dubai (Feb 2026) — Dallas is a primary US target market alongside Los Angeles. Airport actively engaged in planning.",
    keyMilestones: ["Joby commercially operational in Dubai (Feb 2026)", "TX HB 1735 passed 2023", "DFW vertiport feasibility study complete", "Wisk autonomous testing active"],
    lastUpdated: "2026-02-26",
  },
  {
  ...
  },
  {
    ...
    regulatoryPosture: "friendly", hasStateLegislation: true, hasLaancCoverage: true,
    scoreSources: {
      activePilotProgram: { citation: "Las Vegas Convention & Visitors Authority AAM demo program", date: "2024-06" },
      vertiportZoning: { citation: "Clark County vertiport overlay zone approved", date: "2024-04" },
      approvedVertiport: { citation: "LVCC Rooftop Vertiport concept approved, design phase", date: "2024-01" },
      regulatoryPosture: { citation: "Nevada supportive regulatory stance for autonomous aviation", date: "2023-11" },
      stateLegislation: { citation: "NV SB 115 — Drone and UAM regulation update signed", date: "2023-06" },
