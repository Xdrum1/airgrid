...
export const USE_CASE_DATA: Record<string, UseCaseContent> = {
  ...
  "insurance": {
    ...
    color: "#b45309",
    printColor: "#92400e",
    intro: "Aviation liability carriers are covering heliport assets they have never verified. They price risk based on self-reported operator documentation. Several carriers have exited the helicopter insurance market over the last 20 years because they couldn\u2019t manage unquantified exposure. AirIndex \u2014 in partnership with Rex Alexander of Five-Alpha LLC, whose risk analysis methodology was adopted by the FAA in 2013 \u2014 provides portfolio-level compliance screening that gives underwriters ground truth for the first time.",
    ...
    steps: [
      { step: 1, who: "Rex Alexander / Five-Alpha", action: "Opens the carrier relationship. Rex Alexander has 30 years of heliport infrastructure experience, chairs NFPA 418, and is a Fellow of the Royal Aeronautical Society. His risk analysis methodology was adopted by the FAA in 2013. He has standing in the aviation insurance world.", output: "Introduction + framing" },
      { step: 2, who: "AirIndex + Rex", action: "Discovery call. Rex walks through the compliance gap problem using real litigation cases. AirIndex demonstrates portfolio-level screening capability: 5,647 registered sites, three-tier output: compliant / conditional / objectionable.", output: "Scope confirmed" },
      ...
      { step: 4, who: "Rex Alexander", action: "Physical verification on highest-risk sites flagged in pre-screening. Full SMS risk analysis: TLOF/FATO dimensions, obstruction survey, approach path analysis, documentation review. Standards applied: Title 14 CFR Part 5, ICAO annex, ISO 31000.", output: "Site-level compliance determination" },
    ...
    engagements: [
      { product: "Portfolio Compliance Screening", description: "Full portfolio audit. AirIndex automated pre-screening + Rex Alexander physical verification on flagged sites. Deliverable: Portfolio Compliance Screening Report with site-by-site compliance matrix and remediation roadmap. Fee range: $75,000\u2013$150,000 depending on portfolio size.*", access: "Rex introduction required" },
