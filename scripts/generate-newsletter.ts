  ...
  <div style="max-width:760px;margin:0 auto;padding:40px 24px;">
    ...
    <div style="margin-bottom:36px;">
      ...
      <p style="color:#333;font-size:14px;line-height:1.7;margin-bottom:16px;">
        ${fmt(leadMover.cityId)} ${leadMover.score === 100 ? `became one of the U.S. cities to achieve a perfect score on the AirIndex UAM Market Readiness Index this week, jumping from ${leadMover.prevScore} to ${leadMover.score}. ${fmt(leadMover.cityId)} now holds all seven readiness factors: an active pilot program, an approved vertiport, active operator presence, vertiport zoning, a favorable regulatory posture, state legislation, and weather infrastructure.` : `saw its readiness score move from ${leadMover.prevScore} to ${leadMover.score} this week, gaining ground on key readiness factors tracked by the AirIndex UAM Market Readiness Index.`}
      </p>
